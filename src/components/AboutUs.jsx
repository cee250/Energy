  ...
  return (
    <section id="about" className="py-20 md:py-28 bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Header with Energia Pre-title */}
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-3 text-slate-600 text-base">
            We deliver turnkey solar energy systems, agricultural water pumping, and C&I microgrids across Rwanda and East Africa.
          </p>
        </div>

        {/* Story Grid with Energia Dual Photo Overlap */}
        <div className="grid lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          {/* Right Dual Image Stack with Floating Experience Badge */}
          <div className="lg:col-span-6 relative">
            ...
            {/* Floating Experience Badge (Energia signature) */}
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-6">
          {pillars.map((p, idx) => (
            <div key={idx} className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-emerald-300 transition-colors">
